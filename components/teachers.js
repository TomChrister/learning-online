...
const Teachers = () => {
    return (
        <div className="container mx-auto py-40">
            <p className="text-base lg:text-1xl font-semibold text-gray-500 uppercase ml-8">
                Key person
            </p>
            <p className="text-3xl lg:text-5xl font-medium text-black-500 mt-3 ml-8">
                Meet our teachers
            </p>
            <div className="grid grid-cols-1 sm:grid-cols2 lg:grid-cols-3 gap-6 lg:gap-16 py-10">
