...
const Values = () => {
    return (
        <div className="container mx-auto">
            <p className="text-base lg:text-1xl font-semibold text-gray-500 text-center">
                WHY CHOOSE US</p>
            <p className="text-3xl lg:text-5xl font-medium text-black-500 text-center mt-3">
                Our values</p>
            <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-16 py-20">
                <div className="flex flex-col gap-5 items-center">
                    <img src="/assets/v1.svg" alt="v1"/>
                    <p className="text-2xl font-semibold">
                        Speaking clubs</p>
                    <p className="text-gray-500 text-center">
                        In our school you will practice <br/>
